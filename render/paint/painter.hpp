...
namespace browser::render {
    ...
    public:
        ...
        std::shared_ptr<DisplayList> build_display_list(css::LayoutNode *root, f32 offset_x = 0, f32 offset_y = 0);

    private:
        TextRenderer *text_renderer_;
        const std::unordered_map<std::string, std::shared_ptr<image::Image>> *images_ = nullptr;
        void paint_node(DisplayList &list,
                        css::LayoutNode *node,
                        f32 offset_x,
                        f32 offset_y,
                        bool skip_layer_children = false) const;
        ...
        void paint_svg(DisplayList &list, css::LayoutNode *node, f32 ox, f32 oy) const;
        ...
        void paint_text_shadow(DisplayList &list, css::LayoutNode *node, f32 ox, f32 oy) const;
        ...
        Color resolve_color_fallback(const css::ComputedStyle &style,
