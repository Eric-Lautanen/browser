...
private:
    ...
    static Result<internal::GlyphOutline> parse_simple_glyph(const u8* gdata, u32 gsize, i16 num_contours, int bezier_steps = 8);
    Result<internal::GlyphOutline> read_outline(u16 glyph_index, int bezier_steps = 8) const;

    static std::vector<u8> rasterize_scanline(const internal::GlyphOutline& outline,
                                                u32 pw, u32 ph,
